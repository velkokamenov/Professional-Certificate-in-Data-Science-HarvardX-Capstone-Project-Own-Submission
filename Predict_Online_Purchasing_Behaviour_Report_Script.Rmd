...
confmat <- confusionMatrix(Test_Set$Purchase, Log_Reg_Predictions_Test_Set)
...
# Estimate Sensitivity Specificity on Test Set
confmat <- confusionMatrix(Test_Set$Purchase, Test_Probs$s0)
...
# Estimate Sensitivity Specificity on Test Set
confmat <- confusionMatrix(Test_Set$Purchase, Decision_Tree_Predictions_Test_Set)
